        ...
        cards.forEach((e, index) => {
          if (e.dataset.activitie == i.title) {
            ...
            if (i.timeframes.daily.previous != 1) {
              prev[
                index - 1
              ].innerHTML = `yesterday - ${i.timeframes.daily.previous}hrs`;
            } else {
              prev[
                index - 1
              ].innerHTML = `yesterday - ${i.timeframes.daily.previous}hr`;
            }
          }
        });
      }
        ...
        cards.forEach((e, index) => {
          if (e.dataset.activitie == i.title) {
            ...
            if (i.timeframes.daily.previous != 1) {
              prev[
                index - 1
              ].innerHTML = `Last Week - ${i.timeframes.weekly.previous}hrs`;
            } else {
              prev[
                index - 1
              ].innerHTML = `Last Week - ${i.timeframes.weekly.previous}hr`;
            }
          }
        });
      }
        ...
        cards.forEach((e, index) => {
          if (e.dataset.activitie == i.title) {
            ...
            if (i.timeframes.daily.previous != 1) {
              prev[
                index - 1
              ].innerHTML = `Last Month - ${i.timeframes.monthly.previous}hrs`;
            } else {
              prev[
                index - 1
              ].innerHTML = `Last Month - ${i.timeframes.monthly.previous}hr`;
            }
          }
        });
      }
